...
public class AIF183340Test {
    ...
    /**
     * Tes mahasiswa dapat mengambil matakuliah AIF183340
     */
    @Test
    public void testCheckPrasyaratTrue() {
        ...
        AIF183340 instance = new AIF183340();
        mahasiswa.getRiwayatNilai().add(new Mahasiswa.Nilai(new TahunSemester("182"), new AIF183333(), "A"));
    ...
    /**
     * Tes mahasiswa tidak dapat mengambil matakuliah AIF183340.
     */
    @Test
